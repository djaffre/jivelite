...
applets.JogglerSkin2.JogglerSkin2Applet

=head1 DESCRIPTION

This applet implements a small print skin for 1280x960 resolution
...
local log                    = require("jive.utils.log").logger("applet.JogglerSkin2")
...
local imgpath = "applets/JogglerSkin2/images/"
...
function param(self)
		...
		radialClock = {
			...
			minuteTickPath   = 'applets/JogglerSkin2/images/Clocks/Radial/radial_ticks_min_on.png',
		},
...
function skin(self, s)
	-- Nvidia does not support 960 ??
	Framework:setVideoMode(1920, 1080, 0, true)
	...
	local nocturneWallpaper = _loadImageTile(self, "applets/SetupWallpaper/wallpaper/HD_allegro1280_960.png")
	...
	local ALBUMMENU_SMALL_FONT_SIZE = 25
	local TEXTMENU_FONT_SIZE = 64
	local POPUP_TEXT_SIZE_1 = 34
	local POPUP_TEXT_SIZE_2 = 26
	local TRACK_FONT_SIZE = 25
	local TEXTAREA_FONT_SIZE = 25
	local CENTERED_TEXTAREA_FONT_SIZE = 28

	local CM_MENU_HEIGHT = 80
...
--------- ICONBAR ---------
	...
	local NP_ARTISTALBUM_FONT_SIZE = 60
	local NP_TRACK_FONT_SIZE = 150
	...
	s.nowplaying = _uses(s.window, {
		...
		npvisu = {
			...
			vumeter_analog = {
				...
				border = { 0, 0, 0, 0 },
				padding = { 0, 0, 0, 0 },
				bgImg = _loadImage(self, "UNOFFICIAL/VUMeter/vu_analog_25seq_c.png"),
			},
		},
		...
		npprogressNB = {
			...
			position = LAYOUT_NONE,
			x = 1022,
			y = TITLE_HEIGHT + 29 + 26 + 32 + 32 + 23 + 200,
			elapsed = {
				w = WH_FILL,
				align = "left",
				font = _boldfont(18),
